...
export default function WhatsAppAudiovisuales() {
  const [file, setFile] = useState(null);
  const [message, setMessage] = useState("");
  const [title, setTitle] = useState("");
  const [contentType, setContentType] = useState("audiovisual");
                ...
                <FormControl>
                  <Stack direction="row" alignItems="center" spacing={2}>
                    ...
                    <Typography sx={{ fontWeight: 500 }}>
                      Envío después de la creación del lead
                    </Typography>
                  </Stack>
                </FormControl>
                {sendType === "lead" && (
              ...
              >
                ...
                >
                  <Typography sx={{ fontSize: 15, color: "#222" }}>
                    ¡Hola Carlos!
                    <br />
                    Soy Novaly, hemos recibido tu solicitud de contacto.
                    <br />
                    ¿Te gustaría recibir información por este medio?
                  </Typography>
                </Box>
                <Box
                  sx={{
